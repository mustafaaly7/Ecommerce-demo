        ...
        <>
            <div>
                ...
                <div className="flex justify-center flex-col text-center my-6 mx-auto w-1/2  font-bold">
                    <h1 className="text-6xl  md:text-4xl sm:text-xl font-mono text-center mx-auto">DYNAMIC. DOMINANT</h1>
                    <h5 className="my-4 text-lg  font-sans">AJ Brown and the Air max Dn Are Changing the game in their respective fields</h5>
                    <div className=" my-2 ">
